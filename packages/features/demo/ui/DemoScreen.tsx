...
import { ResetCard } from './ResetCard.client';
import { ScenarioCard } from './ScenarioCard.client';
import type { ResetResultView, ScenarioResultView, ScenarioView } from './wire';
...
export const DemoScreen = ({ scenarios, onRun, onReset }: DemoScreenProps): ReactElement => (
  <Stack gap="lg">
    <Stack gap="2xs">
